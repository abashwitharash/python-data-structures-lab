...
#
# Create a tuple named foods containing the same number of foods (strings) as there are names
# in the students list.
# Create a variable named meal and assign an empty string to it.
# Use a for loop to iterate over the strings in foods and append each string to meal.

def combine_foods():
    foods = ['cookies', 'food', 'cheese']
    meal = ''
...
#
# Using the slice operator, assign a new tuple containing only the last two
# food strings in the foods to a variable named last_two_foods.
...
def hometown_info():
    ...
    home_town_message = f'I was born in {home_town['city']} in {home_town["province"]} - population of {home_town["population"]}'
...
# dictionary and append a string with the following
...
#
# Assign to a variable named foods_with_an_a the result of list comprehension 
# that filters the foods tuple to only include food strings that contain the letter 'a'.
...
def filter_foods_with_a():
    foods_with_an_a = [food for food in ('chicken', 'apple', 'salad', 'cheese') if 'a' in food]
